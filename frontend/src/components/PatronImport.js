...
const PatronImport = () => {
  ...
  const handlePreview = async () => {
    ...
    try {
      const response = await adminPatronsAPI.previewPatronImport(formData);
  ...
  const handleImport = async () => {
    ...
    try {
      const response = await adminPatronsAPI.executePatronImport({
  ...
  return (
    <div className="patron-import" style={{ padding: '2rem' }}>
